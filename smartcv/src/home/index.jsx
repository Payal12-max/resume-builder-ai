...
function Home() {
  return (
    ...
    <div className="py-8 px-4 bg-purple-50 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        <a href="#" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
            <span className="text-xs bg-purple-300 rounded-full text-white px-4 py-1.5 mr-3">New</span>
        ...
        <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Effortlessly Craft a Standout Resume with Our AI-Powered Resume Builder</p>
        ...
        <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
            ...
            <div className="flex flex-wrap justify-center items-center mt-8 text-gray-500">
                <a href="https://www.youtube.com/watch?v=QAbAO_rNSDg" className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400">
...
<section className="py-8 bg-purple-50 z-50 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
<h2 className="font-bold text-3xl">How it Works?</h2>
<h2 className="text-md text-purple-950 text-1.4xl">Give mock interview in just 3 simplar easy step</h2>

<div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
      <a
        className="block rounded-xl border bg-purple-200 
         border-gray-200 p-8 shadow-xl transition
         hover:border-pink-500/10 hover:shadow-pink-800/10"
        href="#"
      >
       <AtomIcon className='h-8 w-8'/>

        <h2 className="mt-4 text-xl font-bold text-black">Create Your Interview Prompt</h2>

        <p className="mt-1 text-sm text-gray-600">
          Define the role and key skills you want to practice. Add job details and let AI generate relevant interview questions. You can also include your own custom questions. This helps you create a personalized and focused interview experience.
        </p>
      </a>

      <a
        className="block rounded-xl border bg-purple-200  border-gray-200 p-8 shadow-xl transition hover:border-pink-500/10 hover:shadow-pink-500/10"
        href="#"
      >
      <Edit className='h-8 w-8'/>

        <h2 className="mt-4 text-xl font-bold text-black">Review & Customize Questions </h2>

        <p className="mt-1 text-sm text-gray-600">
          Go through the generated questions and refine them as needed. Edit, remove, or add questions to match your preparation goals. Adjust the difficulty and focus areas. This ensures your mock interview feels realistic and effective.
        </p>
      </a>
      ...
      <Share2 className='h-8 w-8' />
        ...
        <h2 className="mt-4 text-xl font-bold text-black">Start & Track Your Performance</h2>

        <p className="mt-1 text-sm text-gray-600">
          Start your mock interview and answer questions in real time. Get instant feedback on your responses and identify areas to improve. Track your progress over time. Build confidence and get interview-ready with consistent practice.
        </p>
      </a>
